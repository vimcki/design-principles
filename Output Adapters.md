...
But we can implement any other output adapter, for example one that prints data to stdout for debugging or reduction of infrastructure requirements for development.
